---
{"dg-publish":true,"permalink":"/docs/adr/adr-003-dbaas-nivola/","title":"Database PostgreSQL su DBaaS Nivola, esterno al namespace ECaaS","tags":["database","postgresql","dbaas","nivola","infrastruttura"],"dg-note-properties":{"adr":3,"title":"Database PostgreSQL su DBaaS Nivola, esterno al namespace ECaaS","status":"accepted","date":"2026-03-02","deciders":["CSI Piemonte"],"supersedes":[],"superseded-by":[],"tags":["database","postgresql","dbaas","nivola","infrastruttura"],"related_wiki":["[[wiki/concepts/architettura-ecaas\|Architettura ECaaS]]","[[stack-tecnologico-applicativo|Stack Tecnologico Applicativo]]","[[migrazione-postgres-9-17|Migrazione PostgreSQL 9 → 17]]"],"sources":["[[wiki/sources/2026-03-02-domande-srs-csi-v02\|Domande SRS Consensi — Revisione CSI V02]] Q&A #10"]}}
---

...
- Sicurezza identica a [[docs/adr/ADR-005-sicurezza-cdu-15-16\|ADR-005-sicurezza-cdu-15-16]]: OAuth2 CC + JWT + `cons_t_client_ente` + `EnteAuthorizationFilter` + nuovo scope `consensi:snapshot`
...
- Riuso integrale modello sicurezza [[docs/adr/ADR-005-sicurezza-cdu-15-16\|ADR-005-sicurezza-cdu-15-16]] (nuovo scope `consensi:snapshot`)
...
- Correlato: [[docs/adr/ADR-005-sicurezza-cdu-15-16\|ADR-005-sicurezza-cdu-15-16]] sicurezza CDU-15/16 (pattern riusato), [[docs/adr/ADR-007-batch-01-5min-skip-locked\|ADR-007-batch-01-5min-skip-locked]] BATCH-01 5min

...
| §3      | Architettura: sintesi, modello, componenti, GASP, framework, infrastruttura IaaS           | §3.3.1 specifica [[wiki/concepts/gasp-salute\|GASP Salute]]; §3.5.1-3.5.6 infrastruttura [[wiki/concepts/architettura-iaas\|Architettura IaaS]] |                                                 |
